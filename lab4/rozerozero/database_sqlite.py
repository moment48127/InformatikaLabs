...
with sqlite3.connect('database.db') as db:
    ...
    INSERT INTO table_of_nf1(shipper, grade, quality, amount, сost) VALUES('Омск',        'Зерно белое',      'Плохое', 1.1, 10.5);
    ...
    INSERT INTO table_of_nf2_1(shipper, grade, amount) VALUES('Омск',       'Зерно белое',     1.1);
